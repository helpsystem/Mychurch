...
const broadcastRoutes = require('./routes/broadcastRoutes'); // Config/Presentations/Uploads storage
...
app.use('/api/broadcast', broadcastRoutes); // Config/Presentations/File uploads storage
