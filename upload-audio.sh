...
rsync -avz --progress \
    ...
    root@iranianchurchdc.com:/root/Mychurch/backend/bible_data/audio/TPV/
...
echo ""
echo "Verify with:"
echo "ssh root@iranianchurchdc.com 'ls -lah /root/Mychurch/backend/bible_data/audio/TPV/ | head -10'"
