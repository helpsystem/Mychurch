...
export async function emailDocument(
  ...
  subject: string,
  /** Ignored – kept for backwards-compat. Body is now built here. */
  _htmlContent: string,
  pdfBase64?: string,
  pdfFilename?: string,
  imageBase64?: string,
  imageFilename?: string,
  /** The human-readable name of the person the document is addressed to */
  recipientName?: string,
  /** The document reference number (used to build the verify link) */
  refNo?: string,
) {
  try {
