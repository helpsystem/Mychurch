...
const localDict = {
  en: {
    badge: "Pastoral & Leadership Team",
    heading: "Leadership & Ministers",
    subheading: "Pastors, leaders and ministers of the Iranian Evangelical Church of Washington",
    leaders: {
      nazi: {
        role: "Leadership & Pastoral Care",
        badge: "Leadership & Pastoral Care",
        desc: "Oversees fellowship gatherings, leads intercessory prayer, and nurtures warm connections with the church's families, women, and mothers.",
        linkLabel: undefined as string | undefined,
      },
      javad: {
        role: "Senior Pastor",
        badge: "Senior Pastor",
        desc: "Over 15 years of devoted ministry and leadership, teaching God's Word and guiding the community of believers across America and around the world.",
        linkLabel: undefined as string | undefined,
      },
      saman: {
        role: "Deputy & Technical Lead (Admin)",
        badge: "Platform Designer & Developer",
        desc: "Designer and developer of the church's smart platform, lead of the Broadcast team, and coordinator of technical and media operations.",
        linkLabel: "View Website & Résumé",
      },
    },
    welcomeTitle: "Welcome to Our Church",
    welcomeText: "May the Lord bless you — wherever you are in your journey of faith, this close-knit family opens its arms to you.",
    contactPastor: "Contact Our Pastor",
    aboutBeliefs: "About Our Beliefs",
  },
  fa: {
    badge: "تیم شبانی و رهبری",
    heading: "رهبری و خادمین کلیسا",
    subheading: "شبانان، رهبران و خادمین کلیسای انجیلی ایرانیان واشنگتن",
    leaders: {
      nazi: {
    ...
    welcomeTitle: "به کلیسای ما خوش آمدید",
    welcomeText: "خداوند شما را برکت دهد — در هر مرحله از سفر ایمانی که هستید، آغوش این خانواده صمیمی به روی شما گشوده است.",
    contactPastor: "ارتباط با شبان کلیسا",
    aboutBeliefs: "درباره باورهای ما",
  },
  es: {
    badge: "Equipo Pastoral y de Liderazgo",
    heading: "Liderazgo y Ministros",
    subheading: "Pastores, líderes y ministros de la Iglesia Evangélica Iraní de Washington",
    leaders: {
      nazi: {
        role: "Liderazgo y Cuidado Pastoral",
        badge: "Liderazgo y Cuidado Pastoral",
        desc: "Supervisa las reuniones de comunión, dirige la oración de intercesión y cultiva vínculos cercanos con las familias, mujeres y madres de la iglesia.",
        linkLabel: undefined as string | undefined,
      },
      javad: {
        role: "Pastor Principal",
        badge: "Pastor Principal",
        desc: "Más de 15 años de ministerio y liderazgo dedicados, enseñando la Palabra de Dios y guiando a la comunidad de creyentes en Estados Unidos y en todo el mundo.",
        linkLabel: undefined as string | undefined,
      },
      saman: {
        role: "Subdirector y Líder Técnico (Admin)",
        badge: "Diseñador y Desarrollador de la Plataforma",
        desc: "Diseñador y desarrollador de la plataforma inteligente de la iglesia, líder del equipo de transmisión (Broadcast) y coordinador de operaciones técnicas y de medios.",
        linkLabel: "Ver Sitio Web y Currículum",
      },
    },
    welcomeTitle: "Bienvenido a Nuestra Iglesia",
    welcomeText: "Que el Señor te bendiga — sin importar en qué etapa de tu camino de fe te encuentres, esta familia cercana te recibe con los brazos abiertos.",
    contactPastor: "Contactar a Nuestro Pastor",
    aboutBeliefs: "Sobre Nuestras Creencias",
  },
};
...
export default function LeadershipSection() {
  ...
  return (
    <section className="py-20 px-4 max-w-6xl mx-auto relative overflow-hidden" dir={isRTL ? "rtl" : "ltr"}>
      {/* ── Section Header ───────────────────────────────────────────── */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center mb-16">
        {leadersMeta.map((l, i) => {
          const text = d.leaders[l.id as keyof typeof d.leaders];
          const displayName = isRTL ? l.name : l.englishName;
          return (
            <motion.div
              key={l.id}
