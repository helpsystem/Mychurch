...
export const DeviceSettingsModal: React.FC<DeviceSettingsModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
            <div className="bg-neutral-900 w-full max-w-2xl rounded-2xl shadow-2xl border border-white/10 flex flex-col max-h-[90vh]" dir={isRTL ? 'rtl' : 'ltr'}>
                ...
                <div className="flex flex-1 overflow-hidden">
                    {/* Sidebar Tabs */}
                    <div className={`w-48 bg-neutral-950 border-${isRTL ? 'l' : 'r'} border-white/5 p-2 flex flex-col gap-1`}>
                        {tabs.map(tab => (
                            <button
                                key={tab.id}
                                ...
                                className={`flex items-center gap-3 px-4 py-3 rounded-xl transition text-sm font-medium ${activeTab === tab.id
                                    ...
                                    : 'text-slate-400 hover:bg-neutral-800 hover:text-slate-200'
                                    }`}
                            >
                    ...
                    <div className="flex-1 p-6 overflow-y-auto bg-neutral-900">
                        ...
                        {activeTab === 'audio' && (
                            <div className="space-y-6">
                                ...
                                <div className="p-4 bg-neutral-950 rounded-lg border border-white/5 flex flex-col gap-3">
                                    ...
                                    <div className="w-full h-4 bg-neutral-800 rounded-full overflow-hidden relative">
                                        ...
                                        <div className="h-full bg-gradient-to-r from-emerald-500 to-red-500 w-full origin-left animate-[pulse_1.5s_ease-in-out_infinite] scale-x-[0.6]" />
                        ...
                        {activeTab === 'background' && (
                            <div className="space-y-6">
                                {/* Blur Toggle */}
                                <div className="flex items-center justify-between p-4 border border-white/5 rounded-xl bg-black/10">
                                    <div className="flex items-center gap-3">
                ...
                {/* Footer */}
                <div className="p-4 border-t border-white/5 bg-neutral-900 rounded-b-2xl flex justify-end gap-3">
                    <button
                        onClick={onClose}
