 ...
 * شبیه انتخاب بارگذاری در سیستم‌های رزرواسیون
 */
    ...
    const handleAdd = () => {
        if (preview) {
            ...
            const englishVerse: ScripturePage = {
                ...
                textPrimary: (preview.textSecondary && preview.textSecondary.length > 0) ? preview.textSecondary : [''],
                textSecondary: (preview.textPrimary && preview.textPrimary.length > 0) ? preview.textPrimary : ['']
            };
                      ...
                      ${isVerseSelected(verse)
                            ...
                            {preview && !loading && (
                                <div className="bg-slate-800 rounded-lg p-4">
                                    ...
                                    {showEnglish && preview.textSecondary && preview.textSecondary.length > 0 && (
                                        <div className="text-slate-400 text-sm italic space-y-1 mt-2 border-t border-slate-700 pt-2">
                                            {preview.textSecondary.map((line, i) => (
                                              <p key={i}>{line}</p>
                                            ))}
                                        </div>
                                    )}
