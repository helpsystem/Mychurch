...
const localDict = {
    ...
    es: {
        storeTitle: "Tienda Cultural de la Iglesia",
        storeSubtitle: "Apoye nuestro ministerio y explore nuestros libros, guías y artículos de marca.",
        addToCart: "Añadir al Carrito",
        cartTitle: "Carrito de Compras",
        checkout: "Proceder al Pago",
        emptyCart: "Su carrito está vacío.",
        subtotal: "Subtotal",
        shipping: "Envío (según peso)",
        total: "Total Estimado",
        inStock: "En Existencia",
        outOfStock: "Agotado",
        onlyLeft: "quedan solamente",
        backToHome: "Volver al Inicio",
        cartItems: "Artículos",
        checkoutSecure: "Pago Seguro a través de Square",
        processing: "Procesando pago seguro...",
        shippingAddress: "Información de Envío",
        fullName: "Nombre Completo",
        email: "Correo Electrónico",
        addressLine1: "Dirección",
        addressLine2: "Apto, Unidad (Opcional)",
        city: "Ciudad",
