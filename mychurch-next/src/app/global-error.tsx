...
export default function GlobalError({
    ...
    useEffect(() => {
            ...
            if (isChunkError) {
                try {
                    ...
                    if (!lastReload || now - parseInt(lastReload, 10) > 15000) {
                        ...
                        console.warn("Stale client assets or server actions detected at root level. Reloading page...");
                        window.location.reload();
                        return;
                    }
                } catch (e) {
                    console.error("Failed to execute root chunk error auto-reload:", e);
                }
            }
        }
        ...
        fetch("/api/admin/report-error", {
            ...
            keepalive: true,
            body: JSON.stringify({
                message: error?.message || "Root global error boundary",
                code: "NEXT_ROOT_GLOBAL_ERROR_BOUNDARY",
