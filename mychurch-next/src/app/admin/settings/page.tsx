    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col gap-2">
                ...
                <p className="text-muted-foreground">Manage AI providers, Stripe payments, API keys, and global application configurations.</p>
            </div>
            ...
            <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                    Configure a temporary personal Stripe account now and switch to the church payment setup later without changing the public payment page.
                </p>
            </div>
