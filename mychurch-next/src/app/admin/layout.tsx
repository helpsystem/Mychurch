...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="dark flex h-[100dvh] w-full bg-[#09090b] text-neutral-50 font-sans selection:bg-primary/30 relative overflow-hidden">
            ...
            <main className="flex-1 flex flex-col bg-[#09090b] relative overflow-y-auto overflow-x-hidden md:pt-0 pt-16 min-w-0 [direction:ltr]">
                <div className="flex-1 flex flex-col w-full [direction:rtl]">
