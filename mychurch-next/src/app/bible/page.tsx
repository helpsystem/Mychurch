    ...
    <div className="min-h-screen bg-[#0e0e0f] text-white flex flex-col" dir="ltr">
      ...
      <div className="fixed bottom-6 right-6 z-[100]" dir={language === 'fa' ? 'rtl' : 'ltr'}>
        ...
        <motion.button
          ...
          className="flex items-center gap-2 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-black font-bold px-4 py-3 rounded-full shadow-2xl transition-all select-none border border-amber-400/20"
