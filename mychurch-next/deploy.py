...
run_cmd("scp next_build.zip root@iranianchurchdc.com:/root/mychurch-v2/mychurch-next/")
run_cmd("scp -r public/wasm root@iranianchurchdc.com:/root/mychurch-v2/mychurch-next/public/")

print("\n🔄 STEP 4: Extracting and Restarting PM2 Server...")
run_cmd('ssh root@iranianchurchdc.com "cd /root/mychurch-v2/mychurch-next/ && unzip -o next_build.zip && pm2 restart mychurch-next"')
