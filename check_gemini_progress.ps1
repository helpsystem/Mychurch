...
$progressFile = "gemini_progress.json"

if (Test-Path $progressFile) {
    $progress = Get-Content $progressFile | ConvertFrom-Json
    
    Write-Host "`n========================================" -ForegroundColor Cyan
    Write-Host "GEMINI TIMESTAMP GENERATION PROGRESS" -ForegroundColor Cyan
    Write-Host "========================================`n" -ForegroundColor Cyan
    ...
    Write-Host "No progress file found. Gemini processing hasn't started yet." -ForegroundColor Red
}
