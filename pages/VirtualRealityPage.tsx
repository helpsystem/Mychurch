            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="relative rounded-2xl overflow-hidden h-64 flex items-end p-6">
                        ...
                        <img src={VR_BG} alt="Virtual Reality Church" className="absolute inset-0 w-full h-full object-cover" />
                    ...
                    <GlassmorphicCard className="p-6">
                        ...
                        <div className="relative mt-4 h-56 rounded-xl overflow-hidden">
                            ...
                            <img src={CONTROLLER_BG} alt="VR Controller Setup" className="absolute inset-0 w-full h-full object-cover" />
                            <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
