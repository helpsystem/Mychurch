...
import KaraokeWorshipPlayer from './KaraokeWorshipPlayer';
import FullscreenKaraokePlayer from './FullscreenKaraokePlayer';
...
const EnhancedWorshipSongs: React.FC = () => {
  ...
  const openKaraoke = (song: WorshipSong) => {
    console.log('🎤 OPENING KARAOKE MODE', {
      songId: song.id,
      title: song.title,
    ...
    console.log('🎤 State set: showKaraokeMode = true');
  };
